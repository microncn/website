  ...
  return (
    <div className="p-10 grid grid-cols-1 xl:grid-cols-2 lg:p-36 p-20">
      <header className="flex flex-col gap-2 mb-10">
        ...
        <div className="text-neutral-400 flex gap-4 mt-4">
      ...
      <main className="flex flex-col gap-10">
        ...
        <div>
          ...
          <div className="flex flex-col">
            <div className="flex  gap-20 hover:bg-neutral-900 p-4 rounded-md items-center">
...
const GitHubIcon = () => (
  <svg
    ...
    height="16"
    fill="currentColor"
    className="w-6 h-6 hover:text-white duration-200"
    viewBox="0 0 16 16"
  >
